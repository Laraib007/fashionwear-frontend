...
if(footNotAppr.includes(currentPath)){
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <Image src={Logo} height={7} width={50}  />
        <span className="ml-3 text-xl">FashionWear</span>
      </a>
    ...
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/6 md:w-1/2 w-full px-1">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">T-Shirts
</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Stickers
</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Hoodies
</a>
          </li>
          <li>
      ...
      <div className="lg:w-1/5 md:w-1/2 w-full px-1">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Contact Us
</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">About Us
</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Return Policy
</a>
          </li>
          <li>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Privacy Policy
</a>
          </li>
          <li>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2025 FashionWear —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@Mr_LabiKhan</a>
      </p>
